...
def main():
    ...
    with open('output/TUS/column_node_to_semantic_type_dict.pickle', 'wb') as handle:
    ...
    with open('output/TUS/cell_node_to_semantic_type_dict.pickle', 'wb') as handle:
        pickle.dump(cell_node_to_semantic_type_dict, handle)
    with open('output/TUS/predicted_homographs.pickle', 'wb') as handle:
